...
//                            15秒后取消黄色状态
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.diyikeji.homefarm.R.layout.caozuojiemian2);
        ...
        checkBox1 = (RadioButton) findViewById(com.diyikeji.homefarm.R.id.checkBox1);
        checkBox2 = (RadioButton) findViewById(com.diyikeji.homefarm.R.id.checkBox2);
        checkBox3 = (RadioButton) findViewById(com.diyikeji.homefarm.R.id.checkBox3);
        checkBox4 = (RadioButton) findViewById(com.diyikeji.homefarm.R.id.checkBox4);
        checkBox5 = (RadioButton) findViewById(com.diyikeji.homefarm.R.id.checkBox5);
